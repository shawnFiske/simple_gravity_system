...
:: Android packaging
set AND_CERT_NAME="GravitySystemLibary"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\GravitySystemLibary.p12
...
set IOS_PROVISION=cert\GravitySystemLibary.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=GravitySystemLibary
